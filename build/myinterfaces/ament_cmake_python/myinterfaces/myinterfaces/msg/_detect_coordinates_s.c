...
bool myinterfaces__msg__detect_coordinates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("myinterfaces.msg._detect_coordinates.DetectCoordinates", full_classname_dest, 54) == 0);
  }
  myinterfaces__msg__DetectCoordinates * ros_message = _ros_message;
  {  // detection
    ...
    ros_message->detection = (Py_True == field);
    Py_DECREF(field);
  }
  {  // name
  ...
  {  // coordinates
    ...
    geometry_msgs__msg__Point * dest = ros_message->coordinates.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of DetectCoordinates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("myinterfaces.msg._detect_coordinates");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DetectCoordinates");
  ...
  {  // detection
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->detection ? 1 : 0);
    {
