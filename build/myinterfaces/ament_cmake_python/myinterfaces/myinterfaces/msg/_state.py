...
class State(metaclass=Metaclass_State):
    ...
    def __init__(self, **kwargs):
        ...
        self.apriltag = kwargs.get('apriltag', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.apriltag != other.apriltag:
            return False
    ...
    @builtins.property
    def apriltag(self):
        """Message field 'apriltag'."""
        return self._apriltag

    @apriltag.setter
    def apriltag(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'apriltag' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'apriltag' field must be an integer in [-2147483648, 2147483647]"
        self._apriltag = value
    ...
    def task(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'task' field must be an integer in [-2147483648, 2147483647]"
        self._task = value
