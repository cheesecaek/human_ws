...
static const _Humancoordinates_Request_type_support_symbol_names_t _Humancoordinates_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, myinterfaces, srv, Humancoordinates_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, myinterfaces, srv, Humancoordinates_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, myinterfaces, srv, Humancoordinates_Request)() {
  return &::myinterfaces::srv::rosidl_typesupport_c::Humancoordinates_Request_message_type_support_handle;
}
...
static const _Humancoordinates_Response_type_support_symbol_names_t _Humancoordinates_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, myinterfaces, srv, Humancoordinates_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, myinterfaces, srv, Humancoordinates_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, myinterfaces, srv, Humancoordinates_Response)() {
  return &::myinterfaces::srv::rosidl_typesupport_c::Humancoordinates_Response_message_type_support_handle;
}
...
static const _Humancoordinates_type_support_symbol_names_t _Humancoordinates_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, myinterfaces, srv, Humancoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, myinterfaces, srv, Humancoordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, myinterfaces, srv, Humancoordinates)() {
  return &::myinterfaces::srv::rosidl_typesupport_c::Humancoordinates_service_type_support_handle;
}
