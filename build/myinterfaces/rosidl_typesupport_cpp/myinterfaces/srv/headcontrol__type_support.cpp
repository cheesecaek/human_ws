...
static const _Headcontrol_Request_type_support_symbol_names_t _Headcontrol_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, myinterfaces, srv, Headcontrol_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, myinterfaces, srv, Headcontrol_Request)),
  }
};
...
{
  return &::myinterfaces::srv::rosidl_typesupport_cpp::Headcontrol_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, myinterfaces, srv, Headcontrol_Request)() {
  return get_message_type_support_handle<myinterfaces::srv::Headcontrol_Request>();
}
...
static const _Headcontrol_Response_type_support_symbol_names_t _Headcontrol_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, myinterfaces, srv, Headcontrol_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, myinterfaces, srv, Headcontrol_Response)),
  }
};
...
{
  return &::myinterfaces::srv::rosidl_typesupport_cpp::Headcontrol_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, myinterfaces, srv, Headcontrol_Response)() {
  return get_message_type_support_handle<myinterfaces::srv::Headcontrol_Response>();
}
...
static const _Headcontrol_type_support_symbol_names_t _Headcontrol_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, myinterfaces, srv, Headcontrol)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, myinterfaces, srv, Headcontrol)),
  }
};
...
{
  return &::myinterfaces::srv::rosidl_typesupport_cpp::Headcontrol_service_type_support_handle;
}
