...
myinterfaces__srv__Headcontrol_Request__init(myinterfaces__srv__Headcontrol_Request * msg)
{
  ...
  if (!std_msgs__msg__Int8__init(&msg->action)) {
    myinterfaces__srv__Headcontrol_Request__fini(msg);
    return false;
  }
  return true;
}
...
myinterfaces__srv__Headcontrol_Request__create()
{
  ...
  myinterfaces__srv__Headcontrol_Request * msg = (myinterfaces__srv__Headcontrol_Request *)allocator.allocate(sizeof(myinterfaces__srv__Headcontrol_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(myinterfaces__srv__Headcontrol_Request));
  bool success = myinterfaces__srv__Headcontrol_Request__init(msg);
  if (!success) {
...
myinterfaces__srv__Headcontrol_Request__Sequence__init(myinterfaces__srv__Headcontrol_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  myinterfaces__srv__Headcontrol_Request * data = NULL;

  if (size) {
    data = (myinterfaces__srv__Headcontrol_Request *)allocator.zero_allocate(size, sizeof(myinterfaces__srv__Headcontrol_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = myinterfaces__srv__Headcontrol_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        myinterfaces__srv__Headcontrol_Request__fini(&data[i - 1]);
      }
...
myinterfaces__srv__Headcontrol_Request__Sequence__fini(myinterfaces__srv__Headcontrol_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      myinterfaces__srv__Headcontrol_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  myinterfaces__srv__Headcontrol_Request__Sequence * array = (myinterfaces__srv__Headcontrol_Request__Sequence *)allocator.allocate(sizeof(myinterfaces__srv__Headcontrol_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = myinterfaces__srv__Headcontrol_Request__Sequence__init(array, size);
  if (!success) {
...
myinterfaces__srv__Headcontrol_Request__Sequence__destroy(myinterfaces__srv__Headcontrol_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    myinterfaces__srv__Headcontrol_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
myinterfaces__srv__Headcontrol_Request__Sequence__are_equal(const myinterfaces__srv__Headcontrol_Request__Sequence * lhs, const myinterfaces__srv__Headcontrol_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!myinterfaces__srv__Headcontrol_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  myinterfaces__srv__Headcontrol_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(myinterfaces__srv__Headcontrol_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    myinterfaces__srv__Headcontrol_Request * data =
      (myinterfaces__srv__Headcontrol_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!myinterfaces__srv__Headcontrol_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          myinterfaces__srv__Headcontrol_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!myinterfaces__srv__Headcontrol_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  myinterfaces__srv__Headcontrol_Response * msg = (myinterfaces__srv__Headcontrol_Response *)allocator.allocate(sizeof(myinterfaces__srv__Headcontrol_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(myinterfaces__srv__Headcontrol_Response));
  bool success = myinterfaces__srv__Headcontrol_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
myinterfaces__srv__Headcontrol_Response__destroy(myinterfaces__srv__Headcontrol_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    myinterfaces__srv__Headcontrol_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
myinterfaces__srv__Headcontrol_Response__Sequence__init(myinterfaces__srv__Headcontrol_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  myinterfaces__srv__Headcontrol_Response * data = NULL;

  if (size) {
    data = (myinterfaces__srv__Headcontrol_Response *)allocator.zero_allocate(size, sizeof(myinterfaces__srv__Headcontrol_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = myinterfaces__srv__Headcontrol_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        myinterfaces__srv__Headcontrol_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
myinterfaces__srv__Headcontrol_Response__Sequence__fini(myinterfaces__srv__Headcontrol_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      myinterfaces__srv__Headcontrol_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  myinterfaces__srv__Headcontrol_Response__Sequence * array = (myinterfaces__srv__Headcontrol_Response__Sequence *)allocator.allocate(sizeof(myinterfaces__srv__Headcontrol_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = myinterfaces__srv__Headcontrol_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
myinterfaces__srv__Headcontrol_Response__Sequence__destroy(myinterfaces__srv__Headcontrol_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    myinterfaces__srv__Headcontrol_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
myinterfaces__srv__Headcontrol_Response__Sequence__are_equal(const myinterfaces__srv__Headcontrol_Response__Sequence * lhs, const myinterfaces__srv__Headcontrol_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!myinterfaces__srv__Headcontrol_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  myinterfaces__srv__Headcontrol_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(myinterfaces__srv__Headcontrol_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    myinterfaces__srv__Headcontrol_Response * data =
      (myinterfaces__srv__Headcontrol_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!myinterfaces__srv__Headcontrol_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          myinterfaces__srv__Headcontrol_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!myinterfaces__srv__Headcontrol_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
