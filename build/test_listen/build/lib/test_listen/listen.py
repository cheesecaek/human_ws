...
class Listen(Node):
    def __init__(self):
        ...
        self.vel_pub = self.create_publisher(Twist, 'vel_cmd', 10)#balanced stand / walk
        self.robot = RobotCommand()
        self.robot.target_state = 3
