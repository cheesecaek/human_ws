...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, Text):
        ...
        self.BusinessArgs = {"aue": "raw", "auf": "audio/L16;rate=16000", "vcn": "aisxping", "tte": "utf8"}
...
# 在线合成保存的音频格式为pcm,需要将其转化为wav格式文件
...
def tts(text:str):
    ...
    global wsParam
    wsParam = Ws_Param(APPID='48ac8d1a', APISecret='YTU5MmUzMDUxZmYwZjIwOTdmNTBhZWEz',
                       APIKey='6ff86a5211a417132ce89b4d5643727d',
                       Text=text)
