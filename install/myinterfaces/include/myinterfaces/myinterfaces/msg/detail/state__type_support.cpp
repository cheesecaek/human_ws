...
{
  new (message_memory) myinterfaces::msg::State(_init);
}

void State_fini_function(void * message_memory)
{
  auto typed_message = static_cast<myinterfaces::msg::State *>(message_memory);
  typed_message->~State();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember State_message_member_array[2] = {
  {
    ...
    offsetof(myinterfaces::msg::State, apriltag),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(myinterfaces::msg::State, task),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::myinterfaces::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, myinterfaces, msg, State)() {
  return &::myinterfaces::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
