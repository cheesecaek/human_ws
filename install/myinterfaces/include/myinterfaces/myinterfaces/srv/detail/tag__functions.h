...
#ifndef MYINTERFACES__SRV__DETAIL__TAG__FUNCTIONS_H_
#define MYINTERFACES__SRV__DETAIL__TAG__FUNCTIONS_H_
...
/// Create srv/Tag message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * myinterfaces__srv__Tag_Request__init().
...
/// Destroy srv/Tag message.
/**
 * It calls
 * myinterfaces__srv__Tag_Request__fini()
...
/// Check for srv/Tag message equality.
/**
...
/// Initialize array of srv/Tag messages.
/**
...
/// Finalize array of srv/Tag messages.
/**
 * It calls
 * myinterfaces__srv__Tag_Request__fini()
...
/// Create array of srv/Tag messages.
/**
 * It allocates the memory for the array and calls
 * myinterfaces__srv__Tag_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Tag messages.
/**
 * It calls
 * myinterfaces__srv__Tag_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Tag message array equality.
/**
...
/// Copy an array of srv/Tag messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * myinterfaces__srv__Tag_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_myinterfaces
...
/**
 * It calls
 * myinterfaces__srv__Tag_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_myinterfaces
...
/**
 * It allocates the memory for the array and calls
 * myinterfaces__srv__Tag_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_myinterfaces
...
/**
 * It calls
 * myinterfaces__srv__Tag_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MYINTERFACES__SRV__DETAIL__TAG__FUNCTIONS_H_
